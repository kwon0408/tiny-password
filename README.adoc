...
- https://accounts.kakao.com/[카카오계정]: 패스워드 최소 8자 최대 32자. 특수문자 제한 있음(공백)
- http://www.eleparts.co.kr/[엘레파츠]: 패스워드 최소 6자 최대 20자. 특수문자 제한 있음(공백). TLS가 적용된 사이트로 바로 이동하지 않음.
...
- https://qtobox.com/[큐토박스]: 패스워드 최소 10자 최대 16자.
- https://www.aliexpress.com[AliExpress]: 패스워드 최소 8자 최대 20자. 숨겨진 특수문자 제한 있음(따옴표, 공백, 역슬래시).
- https://www.lawtalk.co.kr[로톡]: 패스워드 최소 8자 최대 16자, 특수문자 제한 있음.
- https://hangame.com[한게임]: 패스워드 최소 8자 최대 15자.

== 기타
- https://www.signgate.com[공동인증서]: 패스워드 최소 10자 최대 30자, 특수문자 제한 있음.
